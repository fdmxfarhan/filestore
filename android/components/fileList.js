  ...
  return (
    <View style={styles.container}>
      ...
      <FlatList
          ...
          />
      <RefreshButton setFunction={(data) => {setFiles(data); setShowingFiles(data); setShowingFiles2(data);}} setLoading={setLoading} setPlansEnabled={setPlansEnabled} navigation={navigation} />
