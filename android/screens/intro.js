...
const Intro = (props) => {
    ...
    return(
        <View style={styles.container}>
            ...
            <IntroStep step={3} currentStep={currentStep} source={require('../assets/intro-addfile.jpg')} description={'با وارد کردن اطلاعات فایل می‌توانید یک فایل جدید اضافه کنید. \n دسترسی به این فایل فقط توسط کاربر امکان پذیر است.'} title={'افزودن فایل'} />
            <IntroStep step={4} currentStep={currentStep} source={require('../assets/intro-profile.jpg')} description={'مشخصات کاربر، اشتراک های فعال و مدیریت کاربران \n در این قسمت در دسترس است.'} title={'پروفایل'} />
            <IntroStep step={5} currentStep={currentStep} source={require('../assets/intro-usercontrol.jpg')} description={'در این قسمت می‌توان کاربران را حذف یا اضافه نمود.'} title={'مدیریت کاربران'} />
